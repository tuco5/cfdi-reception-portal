...
export default function Navbar() {
  return (
    <header className="flex h-16 w-full justify-between items-center px-12 shadow-md bg-white bg-opacity-90">
      {/* TODO: Replace for real logo */}
      <div>Logo</div>
      <nav className="w-1/3 flex justify-between max-w-sm h-full items-center">
        {menuLinks.map(({ href, label }) => (
          <Link key={href} href={href} className="border-r border-black w-full text-center last:border-0 transition-all duration-300 hover:bg-black hover:text-white h-1/2 pt-0.5">
            {label}
          </Link>
        ))}
      </nav>
    ...
    <Link href="/signup" className="h-10 w-10">
      <svg width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M14.8088 34.7137C21.6538 33.7141 26.367 33.8003 33.221 34.749C34.2376 34.8897 35 35.77 35 36.8177C35 37.2976 34.8349 37.7641 34.537 38.1273C33.9887 38.7959 33.4572 39.4199 32.941 40H35.5823C35.7483 39.8021 35.9153 39.6006 36.0835 39.3955C36.681 38.6669 37 37.7499 37 36.8177C37 34.7928 35.5221 33.0484 33.4952 32.7679C26.4791 31.7968 21.5747 31.7044 14.5198 32.7347C12.472 33.0337 11 34.8063 11 36.8449C11 37.7504 11.2948 38.6441 11.854 39.3703C12.0186 39.584 12.1821 39.7939 12.3448 40H14.9209C14.4402 39.4261 13.9466 38.8097 13.4386 38.15C13.1554 37.7823 13 37.32 13 36.8449C13 35.7682 13.7739 34.8648 14.8088 34.7137Z"
          fill="currentColor"
        />
        <path
          fill-rule="evenodd"
